...
const USAGE = `import { Glass } from '@thomascaron/opale';
  ...
  render: () => (
    <PageBody>
      ...
      <PropsTable
        ...
        note={
          <>
            ...
            <strong>pas</strong>, une asymétrie que leurs pages respectives signalent.
          </>
        }
        rows={PROPS}
      />
      ...
      <p className="tc-doc-prose">
        ...
        pour se faire une pilule. Il ne l’obtient pas —{' '}
        <a className="tc-doc-link" href={hrefFor('composants/badge')}>
          voir sa page
        </a>
        . Leur <code>Switch</code>, lui, emploie <code>rootStyle</code> et obtient bien ses 999 px :
        les deux écritures sont dans leur source, et une seule des deux marche.
      </p>
